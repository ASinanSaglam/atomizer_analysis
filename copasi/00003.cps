...
<!-- generated with COPASI 4.27 (Build 217) (http://www.copasi.org) at 2021-08-16T18:11:49Z -->
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2021-08-16T18:11:49Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
...
<dcterms:W3CDTF>2021-08-16T18:11:49Z</dcterms:W3CDTF>
  ...
  <Model key="Model_1" name="Goldbeter1991 - Min Mit Oscil" simulationType="time" timeUnit="s" volumeUnit="l" areaUnit="m²" lengthUnit="m" quantityUnit="mol" type="deterministic" avogadroConstant="6.0221408570000002e+23">
    <MiriamAnnotation>
<rdf:RDF
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Metabolite_0">
    ...
    <CopasiMT:isVersionOf>
      ...
      <Metabolite key="Metabolite_1" name="CDC-2 Kinase" simulationType="reactions" compartment="Compartment_0" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_1">
    ...
    <CopasiMT:is rdf:resource="urn:miriam:sbo:SBO:0000252"/>
      ...
      <Metabolite key="Metabolite_2" name="Cyclin Protease" simulationType="reactions" compartment="Compartment_0" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#ModelValue_2">
    ...
    <CopasiMT:is rdf:resource="urn:miriam:sbo:SBO:0000025"/>
  </rdf:Description>
</rdf:RDF>

        </MiriamAnnotation>
      </ModelValue>
      <ModelValue key="ModelValue_3" name="VM3" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:dcterms="http://purl.org/dc/terms/"
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#ModelValue_4">
    ...
    <ListOfReactions>
      <Reaction key="Reaction_0" name="creation of cyclin" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_0">
    ...
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5389" name="v" value="0.025"/>
        </ListOfConstants>
        <KineticLaw function="Function_6" unitType="Default" scalingCompartment="CN=Root,Model=Goldbeter1991 - Min Mit Oscil,Vector=Compartments[cell]">
      ...
      <Reaction key="Reaction_1" name="default degradation of cyclin" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_1">
    ...
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Goldbeter1991 - Min Mit Oscil,Vector=Compartments[cell]">
          <ListOfCallParameters>
      ...
      <Reaction key="Reaction_2" name="cdc2 kinase triggered degration of cyclin" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_2">
    ...
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5387" name="vd" value="0.25"/>
          <Constant key="Parameter_5386" name="Kd" value="0.02"/>
        </ListOfConstants>
        <KineticLaw function="Function_39" unitType="Default" scalingCompartment="CN=Root,Model=Goldbeter1991 - Min Mit Oscil,Vector=Compartments[cell]">
          <ListOfCallParameters>
      ...
      <Reaction key="Reaction_3" name="activation of cdc2 kinase" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_3">
    ...
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5385" name="K1" value="0.005"/>
          <Constant key="Parameter_5384" name="V1" value="0.0588235"/>
        </ListOfConstants>
        <KineticLaw function="Function_40" unitType="Default" scalingCompartment="CN=Root,Model=Goldbeter1991 - Min Mit Oscil,Vector=Compartments[cell]">
          <ListOfCallParameters>
      ...
      <Reaction key="Reaction_4" name="deactivation of cdc2 kinase" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_4">
    ...
    <CopasiMT:isVersionOf>
      <rdf:Bag>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5383" name="V2" value="1.5"/>
          <Constant key="Parameter_5382" name="K2" value="0.005"/>
        </ListOfConstants>
        <KineticLaw function="Function_41" unitType="Default" scalingCompartment="CN=Root,Model=Goldbeter1991 - Min Mit Oscil,Vector=Compartments[cell]">
          <ListOfCallParameters>
      ...
      <Reaction key="Reaction_5" name="activation of cyclin protease" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:dcterms="http://purl.org/dc/terms/"
  ...
  <rdf:Description rdf:about="#Reaction_5">
    ...
    <CopasiMT:is rdf:resource="urn:miriam:sbo:SBO:0000216"/>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5381" name="K3" value="0.005"/>
          <Constant key="Parameter_5380" name="V3" value="0.01"/>
        </ListOfConstants>
        <KineticLaw function="Function_42" unitType="Default" scalingCompartment="CN=Root,Model=Goldbeter1991 - Min Mit Oscil,Vector=Compartments[cell]">
          <ListOfCallParameters>
      ...
      <Reaction key="Reaction_6" name="deactivation of cyclin protease" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:dcterms="http://purl.org/dc/terms/"
  ...
  <rdf:Description rdf:about="#Reaction_6">
    ...
    <CopasiMT:is rdf:resource="urn:miriam:sbo:SBO:0000330"/>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5379" name="K4" value="0.005"/>
          <Constant key="Parameter_5378" name="V4" value="0.5"/>
        </ListOfConstants>
        <KineticLaw function="Function_43" unitType="Default" scalingCompartment="CN=Root,Model=Goldbeter1991 - Min Mit Oscil,Vector=Compartments[cell]">
          <ListOfCallParameters>
...
<dcterms:W3CDTF>2021-08-16T18:11:49Z</dcterms:W3CDTF>
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=Goldbeter1991 - Min Mit Oscil,Vector=Compartments[cell],Vector=Metabolites[Cyclin]" value="6.0221408570000005e+21" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Goldbeter1991 - Min Mit Oscil,Vector=Compartments[cell],Vector=Metabolites[CDC-2 Kinase]" value="6.0221408570000005e+21" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Goldbeter1991 - Min Mit Oscil,Vector=Compartments[cell],Vector=Metabolites[Cyclin Protease]" value="6.0221408570000005e+21" type="Species" simulationType="reactions"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=Goldbeter1991 - Min Mit Oscil,Vector=Values[V1]" value="0.058823529411764698" type="ModelValue" simulationType="assignment"/>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=Goldbeter1991 - Min Mit Oscil,Vector=Reactions[creation of cyclin]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Goldbeter1991 - Min Mit Oscil,Vector=Reactions[creation of cyclin],ParameterGroup=Parameters,Parameter=v" value="0.025000000000000001" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          ...
          <ModelParameterGroup cn="CN=Root,Model=Goldbeter1991 - Min Mit Oscil,Vector=Reactions[activation of cdc2 kinase]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Goldbeter1991 - Min Mit Oscil,Vector=Reactions[activation of cdc2 kinase],ParameterGroup=Parameters,Parameter=K1" value="0.0050000000000000001" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=Goldbeter1991 - Min Mit Oscil,Vector=Reactions[activation of cdc2 kinase],ParameterGroup=Parameters,Parameter=V1" value="0.058823529411764698" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=Goldbeter1991 - Min Mit Oscil,Vector=Reactions[deactivation of cdc2 kinase]" type="Reaction">
            ...
            <ModelParameter cn="CN=Root,Model=Goldbeter1991 - Min Mit Oscil,Vector=Reactions[deactivation of cdc2 kinase],ParameterGroup=Parameters,Parameter=K2" value="0.0050000000000000001" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Goldbeter1991 - Min Mit Oscil,Vector=Reactions[activation of cyclin protease]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Goldbeter1991 - Min Mit Oscil,Vector=Reactions[activation of cyclin protease],ParameterGroup=Parameters,Parameter=K3" value="0.0050000000000000001" type="ReactionParameter" simulationType="fixed"/>
          ...
          <ModelParameterGroup cn="CN=Root,Model=Goldbeter1991 - Min Mit Oscil,Vector=Reactions[deactivation of cyclin protease]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Goldbeter1991 - Min Mit Oscil,Vector=Reactions[deactivation of cyclin protease],ParameterGroup=Parameters,Parameter=K4" value="0.0050000000000000001" type="ReactionParameter" simulationType="fixed"/>
    ...
    <InitialState type="initialState">
      0 6.0221408570000005e+21 6.0221408570000005e+21 6.0221408570000005e+21 0.058823529411764698 0.01 1 3 1 0.5 
    </InitialState>
  </Model>
  <ListOfTasks>
...
<Report reference="Report_100" target="00003_tc.dat" append="0" confirmOverwrite="1"/>
      <Problem>
...
<Object cn="CN=Root,Model=Goldbeter1991 - Min Mit Oscil,Vector=Compartments[cell],Vector=Metabolites[Cyclin Protease],Reference=Concentration"/>
  ...
  <SBMLReference file="../curated/bmd0000000003.xml">
